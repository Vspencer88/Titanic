...
forest <- randomForest(as.factor(Survived) ~ Pclass + Sex + Age +  Fare + Family + Title, data = train, importance = TRUE, ntree = 1000)
...
write.csv(solution,file = "C:/Users/vspen/Documents/Programming/R/random forest titanic solution.csv",row.names = FALSE)