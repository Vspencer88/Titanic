...
### Run and plot Decision Tree model
tree <- rpart(Survived ~Pclass + Sex + Age + Family + Fare + Title, data = train,method = "class")
fancyRpartPlot(tree)
...
write.csv(solution,file = "C:/Users/vspen/Documents/Programming/R/Titanic/decision tree titanic solution.csv",row.names = FALSE)